                ...
                <tr data-asset-id="${item.id}" style="${rowStyle}">
                    ...
                    <td>
                        <select class="modal-select-status">
                            ...
                            <option value="💸 Done Transfer (Perpindahan aset melalui sistem)" ${item.statusPengiriman.includes('Done Transfer') ? 'selected' : ''}>💸 Done Transfer (Perpindahan aset melalui sistem)</option>
                        </select>
                    </td>
                    <td>
